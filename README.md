...
- Download the latest release : [https://github.com/sandorbx/MADI3D/releases/download/v25.092/MADI3D_v26.16.zip](https://github.com/sandorbx/MADI3D/releases/download/v26.16/MADI3D_v26.16.zip) , unzip in a folder and run the exe file.
